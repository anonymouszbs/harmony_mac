...
import '../../pages/centersUI/controller/bodycontroller.dart';
...
class ResizableDraggableWidget extends StatefulWidget {
  const ResizableDraggableWidget(
      ...
      this.bgColor,
      this.squareColor,
      this.changed, this.index, this.clean})
      : super(key: key);
...
class _ResizableDraggableWidgetState extends State<ResizableDraggableWidget> with TickerProviderStateMixin{
    ...
    return _draggable
        ?  Transform.translate(
            ...
            child:   GestureDetector(
              ...
              bodyController.showtableMENU(context,details);
              bodyController.tableSelectIndex = widget.index!;
              },
